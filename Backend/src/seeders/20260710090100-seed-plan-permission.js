...
// covers group/company but missed plans (needed to populate a plan dropdown
// on Create Group/Create Company) — added here as a follow-up batch rather
// than editing the already-applied seeder file. Super Admin is granted
// explicitly rather than relying on 'ALL' being recomputed on a partial reseed.
const PERMISSIONS = [['tenancy', 'plan:read', 'View subscription plans']];

const ROLE_GRANTS = {
  'Super Admin': ['plan:read'],
  'Group Admin': ['plan:read'],
  'Company Admin': ['plan:read'],
};
