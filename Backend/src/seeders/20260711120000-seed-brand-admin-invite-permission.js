...
// Brand Admin's Employees page gained an "Employee Self-Service Access"
// invite feature mirroring Company Admin's EmployeeDetailModal (2026-07-11).
// user:invite already exists (base seeder) — this just grants it to Brand
// Admin. auth.controller.js::signupInviteEmployee now also accepts an
// optional brandId, enforced against the target employee's own brandId in
// auth.service.js::inviteEmployeeUser, so this grant can't be used to invite
// an employee outside the caller's own brand.
const ROLE_GRANTS = {
  'Brand Admin': ['user:invite'],
};
