...
// The older, already-dormant secretKey-based QR-terminal flow (superseded
// by the office-kiosk flow before face recognition was even discussed) —
// user-confirmed for deletion. Must run after
// 20260803100200-drop-qr-webauthn-columns-from-attendance.js, which already
// dropped attendance.terminal_id's FK reference to this table.
module.exports = {
