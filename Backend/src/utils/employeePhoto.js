...
// break a list/read that happens to include employee photos. Used by
// attendance.service.js; employee.service.js keeps its own withPhotoUrl
// (different input shape — a record it then spreads onto via .toJSON()).
