    ...
    <div className="space-y-4">
      ...
      {(isLoading || employees.length > 0) && (
        <>
          ...
          {/* Mobile: same trimmed, tap-to-expand card as Company Admin's
              Employees page — name/department/designation only, everything
              else lives behind EmployeeDetailModal. */}
